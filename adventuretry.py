...
rooms = {  
   'sitting':{  
      'name':'in the sitting room of the abadoned house',
      'east':'bedroom',
      'north':'chamber',
   ...
   'bedroom':{  
      ...
      'west':'sitting',
      'north':'chamber',
      'text':'This seems to be a haven for long lost souls. The deceased clothes are in the closet and the souls reflect on you in the mirror. The windows refuse to open.',
